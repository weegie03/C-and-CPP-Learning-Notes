...
{
	int box[8];
	box[0] = (int)X(cx - size*0.5f); box[1] = (int)Y(cy + size*0.5f);
	box[2] = (int)X(cx + size*0.5f); box[3] = (int)Y(cy + size*0.5f);
	box[4] = (int)X(cx + size*0.5f); box[5] = (int)Y(cy - size*0.5f);
	box[6] = (int)X(cx - size*0.5f); box[7] = (int)Y(cy - size*0.5f);
...
{
	int box[8];
	box[0] = (int)X(cx - BOX_SIZE * 0.5f); box[1] = (int)Y(cy + BOX_SIZE * 0.5f);
	box[2] = (int)X(cx + BOX_SIZE * 0.5f); box[3] = (int)Y(cy + BOX_SIZE * 0.5f);
	box[4] = (int)X(cx + BOX_SIZE * 0.5f); box[5] = (int)Y(cy - BOX_SIZE * 0.5f);
	box[6] = (int)X(cx - BOX_SIZE*0.5f); box[7] = (int)Y(cy - BOX_SIZE*0.5f);
